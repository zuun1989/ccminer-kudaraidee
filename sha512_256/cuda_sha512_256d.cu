/*
 * sha512_256d CUDA implementation.
 * xiaolin1579 2022
 */
...
__host__
static void sha512_256_step1_host(uint32_t a, uint32_t b, uint32_t c, uint32_t &d,
...
__host__
static void sha512_256_step2_host(uint32_t a, uint32_t b, uint32_t c, uint32_t &d,
	uint32_t e, uint32_t f, uint32_t g, uint32_t &h,
...
__host__
static void sha512_256_round_body_host(uint32_t* in, uint32_t* state, const uint32_t* Kshared)
{
	uint32_t a = state[0];
	uint32_t b = state[1];
	uint32_t c = state[2];
	...
	sha512_256_step1_host(a,b,c,d,e,f,g,h,in[ 0], Kshared[ 0]);
	sha512_256_step1_host(h,a,b,c,d,e,f,g,in[ 1], Kshared[ 1]);
	sha512_256_step1_host(g,h,a,b,c,d,e,f,in[ 2], Kshared[ 2]);
	sha512_256_step1_host(f,g,h,a,b,c,d,e,in[ 3], Kshared[ 3]);
	sha512_256_step1_host(e,f,g,h,a,b,c,d,in[ 4], Kshared[ 4]);
	sha512_256_step1_host(d,e,f,g,h,a,b,c,in[ 5], Kshared[ 5]);
	sha512_256_step1_host(c,d,e,f,g,h,a,b,in[ 6], Kshared[ 6]);
	sha512_256_step1_host(b,c,d,e,f,g,h,a,in[ 7], Kshared[ 7]);
	sha512_256_step1_host(a,b,c,d,e,f,g,h,in[ 8], Kshared[ 8]);
	sha512_256_step1_host(h,a,b,c,d,e,f,g,in[ 9], Kshared[ 9]);
	sha512_256_step1_host(g,h,a,b,c,d,e,f,in[10], Kshared[10]);
	sha512_256_step1_host(f,g,h,a,b,c,d,e,in[11], Kshared[11]);
	sha512_256_step1_host(e,f,g,h,a,b,c,d,in[12], Kshared[12]);
	sha512_256_step1_host(d,e,f,g,h,a,b,c,in[13], Kshared[13]);
	sha512_256_step1_host(c,d,e,f,g,h,a,b,in[14], Kshared[14]);
	sha512_256_step1_host(b,c,d,e,f,g,h,a,in[15], Kshared[15]);

	for (int i=0; i<3; i++)
	{
		sha512_256_step2_host(a,b,c,d,e,f,g,h,in,0, Kshared[16+16*i]);
		sha512_256_step2_host(h,a,b,c,d,e,f,g,in,1, Kshared[17+16*i]);
		sha512_256_step2_host(g,h,a,b,c,d,e,f,in,2, Kshared[18+16*i]);
		sha512_256_step2_host(f,g,h,a,b,c,d,e,in,3, Kshared[19+16*i]);
		sha512_256_step2_host(e,f,g,h,a,b,c,d,in,4, Kshared[20+16*i]);
		sha512_256_step2_host(d,e,f,g,h,a,b,c,in,5, Kshared[21+16*i]);
		sha512_256_step2_host(c,d,e,f,g,h,a,b,in,6, Kshared[22+16*i]);
		sha512_256_step2_host(b,c,d,e,f,g,h,a,in,7, Kshared[23+16*i]);
		sha512_256_step2_host(a,b,c,d,e,f,g,h,in,8, Kshared[24+16*i]);
		sha512_256_step2_host(h,a,b,c,d,e,f,g,in,9, Kshared[25+16*i]);
		sha512_256_step2_host(g,h,a,b,c,d,e,f,in,10,Kshared[26+16*i]);
		sha512_256_step2_host(f,g,h,a,b,c,d,e,in,11,Kshared[27+16*i]);
		sha512_256_step2_host(e,f,g,h,a,b,c,d,in,12,Kshared[28+16*i]);
		sha512_256_step2_host(d,e,f,g,h,a,b,c,in,13,Kshared[29+16*i]);
		sha512_256_step2_host(c,d,e,f,g,h,a,b,in,14,Kshared[30+16*i]);
		sha512_256_step2_host(b,c,d,e,f,g,h,a,in,15,Kshared[31+16*i]);
	}
...
__device__
static void sha512_256_round_body(uint32_t* in, uint32_t* state, uint32_t* const Kshared)
{
	uint32_t a = state[0];
	uint32_t b = state[1];
	uint32_t c = state[2];
...
__device__
static void sha512_256_round_last(uint32_t* in, uint32_t* state, uint32_t* const Kshared)
{
	uint32_t a = state[0];
	uint32_t b = state[1];
	uint32_t c = state[2];
...
void sha512_256d_gpu_hash_shared(const uint32_t threads, const uint32_t startNonce, uint32_t *resNonces)
{
	...
	if (thread < threads)
	{
		...
		sha512_256_round_body(dat, buf, s_K);
		...
		sha512_256_round_last(dat, buf, s_K);
...
__host__
void sha512_256d_init(int thr_id)
{
...
__host__
void sha512_256d_free(int thr_id)
{
...
__host__
void sha512_256d_setBlock_80(uint32_t *pdata, uint32_t *ptarget)
{
	...
	sha512_256_round_body_host(in, buf, cpu_K);
...
__host__
void sha512_256d_hash_80(int thr_id, uint32_t threads, uint32_t startNonce, uint32_t *resNonces)
{
	...
	sha512_256d_gpu_hash_shared <<<grid, block>>> (threads, startNonce, d_resNonces[thr_id]);
	cudaThreadSynchronize();
