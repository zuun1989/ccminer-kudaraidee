...
extern int scanhash_sha512_256d(int thr_id, struct work *work, uint32_t max_nonce, unsigned long *hashes_done);
...
extern void free_sha512_256d(int thr_id);
...
void sha512_256d_hash(void *output, const void *input);
