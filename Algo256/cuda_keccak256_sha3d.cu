...
void keccak256_sha3d_gpu_hash_80(uint32_t threads, uint32_t startNounce, uint32_t *resNounce)
{
...
__host__
void keccak256_sha3d_hash_80(int thr_id, uint32_t threads, uint32_t startNounce, uint32_t *resNonces, int order)
{
...
void keccak256_sha3d_gpu_hash_32(uint32_t threads, uint32_t startNounce, uint64_t *outputHash)
{
	uint32_t thread = (blockDim.x * blockIdx.x + threadIdx.x);
	if (thread < threads)
	{
...
__host__
void keccak256_sha3d_hash_32(int thr_id, uint32_t threads, uint32_t startNounce, uint64_t *d_outputHash, int order)
{
	...
	keccak256_sha3d_gpu_hash_32 <<<grid, block>>> (threads, startNounce, d_outputHash);
	MyStreamSynchronize(NULL, order, thr_id);
}
#endif

__host__
void keccak256_sha3d_setBlock_80(void *pdata,const void *pTargetIn)
{
...
__host__
void keccak256_sha3d_init(int thr_id, uint32_t threads)
{
...
__host__
void keccak256_sha3d_free(int thr_id)
{
