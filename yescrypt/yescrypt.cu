...
int scanhash_yescrypt_base(int thr_id, struct work *work, uint32_t max_nonce, unsigned long *hashes_done, const uint32_t N, const uint32_t r, const uint32_t p,
